...
public interface SystemMenuService {
     ...
     * @throws com.tamboot.web.config.BusinessException if required form fields not set, or parent menu not exists
     */
     ...
     * @throws com.tamboot.web.config.BusinessException if {@code id} is null, or menu item not exists
     */
     ...
     * @return menu tree, never null
     * @throws com.tamboot.web.config.BusinessException if {@code roleId} is null, or role not exists
     */
